...
<head>
    <meta charset="utf-8">
    <title>Notes | My archived notes</title>
...
<header>
    <div class="container">
        ...
        <div class="page-title" style="color:#ffcc00;">
            <h1 class="display-4"><i>My archived notes</i></h1>
        </div>
    </div>
</header>
<body>
  <div class="container">
    ...
    <c:choose>
        <c:when test="${not empty archivedNotesList}">
            <div class="notes-list">
                <c:forEach items="${archivedNotesList}" var="note" varStatus="notesLoop">
                    <div class="notes-list-note">
                        <h6 style="display: inline-block;"><font size="+1">${note.title}</font></h6>
                        ...
                        <div class="notes-list-note-buttons">
                            <form:form method="POST" modelAttribute="noteForm" action="${contextPath}/note-editor?mode=view" style='display:inline-block;'>
                                ...
                                <button class="btn btn-info btn-sm" type="submit">View note${loop.last}</button>
                            </form:form>
